...
function App() {
  ...
  return <main className="canvas-app">
    <header className="topbar"><div className="brand"><span className="brand-mark"><GitBranch size={17}/></span><strong>CanvasFlow</strong></div><div className="flow-title"><span>工作流</span><span>/</span><strong>客户信息补全</strong><span className="draft">草稿</span></div><div className="top-actions"><span className="saved"><Check size={14}/> 刚刚保存</span><button className="avatar" title="账户">MC</button></div></header>
